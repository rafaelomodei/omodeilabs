...
export function TeamCard({ name, role, description, image, linkedin }: TeamCardProps) {
  return (
    <div className="group overflow-hidden rounded-2xl border border-[#6B7D5B]/20 bg-[#2A2A2A]/40 backdrop-blur-sm transition-all duration-500 hover:border-[#6B7D5B]/50">
      ...
      <div className="relative z-10 space-y-3 p-6">
        <div className="flex items-start justify-between gap-4">
          <div>
            <p className="text-sm text-[#6B7D5B]">{role}</p>
